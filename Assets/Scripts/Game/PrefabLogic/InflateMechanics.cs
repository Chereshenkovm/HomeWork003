...
public class InflateMechanics : MonoBehaviour
{
    ...
    [Header("Звук смерти")] [SerializeField]
    ...
    [Header("Префаб системы частиц, вызывающийся после того, как лопнет глаз")]
    ...
    private void OnDestroy()
    {
        if (!apQuit)
        {
            ...
            _soundManager.CreateSoundObject().Play(deathClip, transform.position, 0.5f, 0.3f);
        }
    }
